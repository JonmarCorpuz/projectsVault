# Setting Up KeepAlived on the HAProxy for Zabbix's Frontend 
...
# Setting Up KeepAlived on the HAProxy for Zabbix's Backend 
...
vrrp_instance VI_1 {
    ...
    virtual_ipaddress {
        192.168.0.200              # Configure the Virtual IP address to be managed by VRRP and failover
    }
    track_script {
        chk_haproxy                # Specify to use the defined script to monitor HAProxy service health
    }
